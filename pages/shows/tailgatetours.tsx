              ...
              <div className="relative isolate overflow-hidden">
                <div className="mx-auto max-w-7xl pt-10 pb-24 sm:pb-32 lg:grid lg:grid-cols-2 lg:gap-x-8 lg:py-40 lg:px-8">
                  ...
                  <div className="sm:mt-10 md:mx-auto md:max-w-2xl lg:mx-0 lg:mt-0 lg:w-screen">
                    <video src="https://img.otkdata.com/esfandtv/esfans/Tailgate_Tour_Final.mp4" typeof="video/mp4" muted autoPlay playsInline loop className="w-full h-96 left-0 top-0 overflow-hidden rounded-lg" />
                  </div>
                </div>
